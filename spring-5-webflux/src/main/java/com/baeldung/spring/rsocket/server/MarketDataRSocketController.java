...
/*     @MessageMapping("**")
    public Flux<MarketData> feedMarketData(MarketDataRequest marketDataRequest) {
     ...
     @MessageMapping("**")
    public Flux<MarketData> feedMarketData() {
        System.out.println ("market datat called");
        return marketDataRepository.getAll("ibm");
    }  
...
/*   @MessageMapping("**")
  Flux<String> myMessage() {
      System.out.println ("my message called");
    return Flux.just(new String("hello world"));
  }   */
